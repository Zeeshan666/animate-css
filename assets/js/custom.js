...
$('.pricing-anchors').click(function(){
	$('.pricing-anchors').removeClass('active');
...
//setTimeout(function(){
	//$('#load-popup-halloween').modal('show');	
	//},8000);
...
//        }
 ...
 $("#copy").owlCarousel({
   ...
   // 1) ASSIGN EACH 'DOT' A NUMBER
	...
	$('body').delegate('.resp-tabs-list li','click',function(){
		$('.resp-tabs-list li').removeClass('resp-tab-active');
			$(this).addClass('resp-tab-active');
			var gettab = $(this).attr('data-target');
			//console.log(gettab);
			$('.out_tab .inner_tab').fadeOut();
			$('#'+gettab).fadeIn();
			
			
				var	gtindex = $(this).index();
					//console.log(gtindex);
					$('.works .owl-dot:eq('+gtindex+')').trigger('click');
...
pagination  :false,dots:false,
 ...
 var owllaptop = $("#owl-demo-laptop");            
    owllaptop.owlCarousel({
		      items : 1,                         //10 items above 1000px browser width   
        loop:true,
		nav:false,
		 autoplay: true,
...
pagination  :false,dots:false,
 ...
 var owliphone = $("#owl-demo-iphone");            
    owliphone.owlCarousel({
		      items : 1,                         //10 items above 1000px browser width   
        loop:true,
		nav:false,
		 autoplay: true,
...
owl3.on('changed.owl.carousel',function(property){
	...
	//console.log(current);
	$('.resp-tabs-list li').removeClass('resp-tab-active');
  $( ".resp-tabs-list li:eq("+current+")").addClass('resp-tab-active').trigger('click');
